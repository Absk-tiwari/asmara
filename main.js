...
// When update is downloaded. Ready to install
...
app.on('ready', () => 
{
    ...
    if (customerDisplay) {
        ...
        customerWindow.loadURL("http://localhost:5101/#/pos/customer");
...
ipcMain.on("print-content", (event, content) => {
    ...
    const html = `<html><style> @page{ size:auto; margin:-5mm 3mm 3mm 2mm }
        *{font-weight:400!important;text-transform:uppercase;font-size:0.85rem!important;font-family:system-ui!important}
        ...
        .row{padding:0px!important;min-height:10px!important;border:0px!important;margin-top:-0.1rem!important}
...
process.on('uncaughtException', function (err) {
    mainWindow.webContents.send("has-error", err.message)
});
